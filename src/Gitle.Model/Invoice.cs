...
namespace Gitle.Model
{
  public class Invoice : ModelBase
  {
    ...
    public Invoice(Application application, Project project, DateTime startDate, DateTime endDate)
        : this()
    {
    ...
    public Invoice(Application application, Project project, DateTime startDate, DateTime endDate, IList<Booking> bookings)
        : this(application, project, startDate, endDate)
    {
