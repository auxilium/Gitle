namespace Gitle.Model
{
  ...
  public class Project : ModelBase, IDocumentContainer, ISlugger
  {
    ...
    public virtual double BilledHoursBudgetHours()
    {
      return BudgetHours - TotalDefinitiveHours();
    }

    public virtual double BilledHoursTotalHours()
    {
      return TotalHours - TotalDefinitiveHours();
    }
    ...
    public virtual double ProgressTotalHours()
    {
      return TotalHours / BudgetHours * 100;
    }

    public virtual double ProgressTotalDefinitiveHours()
    {
      return BudgetHours / TotalDefinitiveHours() * 100;  
    }
    ...
    public virtual double PercentageTotalHoursOfBudgetHours()
    {
      var budgetHours = BudgetHours;
      return budgetHours / BilledHoursBudgetHours() * 100;
    }
