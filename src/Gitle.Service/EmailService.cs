namespace Gitle.Service
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public void SendIssueActionNotification(IIssueAction action)
        {
            ...
            IList<User> users = (from userProject in project.Users where userProject.Notifications && 
                                                                         (!userProject.OnlyOwnIssues || action.Issue.CreatedBy == userProject.User) && 
                                                                         userProject.IsActive && userProject.User.IsActive select userProject.User).ToList();
